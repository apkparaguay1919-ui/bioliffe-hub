...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: [
      "La Moringa oleifera es un árbol originario del sur del Himalaya, en el norte de la India, donde se utiliza desde hace siglos en la alimentación tradicional. Con el tiempo, su cultivo se extendió a regiones tropicales y subtropicales de África, Asia y América Latina, incluido Paraguay.",
  ...
  },
  {
    ...
    content: [
      ...
      "Dentro de Bioliffe Moringa Paraguay, ese liderazgo se apoya en pilares concretos: visión, disciplina, servicio, comunicación, seguimiento, ejemplo, duplicación y comunidad.",

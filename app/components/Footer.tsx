...
// oficial de Bioliffe Moringa Paraguay apenas estén disponibles. Mientras
...
const SOCIAL_LINKS = [
  ...
  { icon: Facebook, label: "Facebook", href: "https://www.facebook.com/search/top?q=Bioliffe%20Moringa%20Paraguay" },
  { icon: Instagram, label: "Instagram", href: "https://www.instagram.com/explore/search/keyword/?q=Bioliffe%20Moringa%20Paraguay" },
  { icon: Music2, label: "TikTok", href: "https://www.tiktok.com/search?q=Bioliffe%20Moringa%20Paraguay" },
  { icon: Send, label: "Telegram", href: "https://t.me/s/BioliffeMoringaParaguay" },
];
      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-10 mb-12">
          <div className="lg:col-span-2">
            <h3 className="text-white font-bold text-lg mb-3">Bioliffe Moringa Paraguay</h3>

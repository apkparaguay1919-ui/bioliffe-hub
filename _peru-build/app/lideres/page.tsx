...
export const metadata: Metadata = {
  title: "Líderes | Bioliffe Moringa Perú",
  description:
    "Conocé al liderazgo de Bioliffe Moringa Perú y el sistema de mentoría que forma nuevos líderes cada mes.",
  openGraph: {
    title: "Líderes | Bioliffe Moringa Perú",
    description: "El liderazgo y el sistema de mentoría de Bioliffe Moringa Perú.",
    url: "https://www.bioliffemoringaperu.com/lideres",
  },
};
              ...
              <div className="grid md:grid-cols-2">
                <div className="p-10 flex flex-col justify-center border-b md:border-b-0 md:border-r border-white/10">
                  ...
                  <p className="text-white/60 leading-relaxed mb-6">
                    Fundador de Bioliffe Moringa Perú, listado como Recommended Distributor en Business For Home,

...
export const metadata: Metadata = {
  title: "Nosotros | Bioliffe Moringa Perú",
  description:
    "Conocé la historia, misión, visión y valores de Bioliffe Moringa Perú: bienestar, liderazgo y oportunidad de negocio.",
  openGraph: {
    title: "Nosotros | Bioliffe Moringa Perú",
    description: "Historia, misión, visión y valores de Bioliffe Moringa Perú.",
    url: "https://www.bioliffemoringaperu.com/nosotros",
  },
};
...
const VALUES = [
  ...
  { icon: "🌎", title: "Visión regional", desc: "Pensamos en Perú, Paraguay y Latinoamérica como una sola comunidad en crecimiento." },
...
const TIMELINE = [
  ...
  {
    year: "2026",
    title: "Bioliffe Moringa Perú Hub",
  ...
  },
  {
    ...
    desc: "Seguimos sumando distribuidores, productos y contenido para la comunidad en Perú, Paraguay y el resto de Latinoamérica.",
  },
];
        ...
        <div className="max-w-4xl mx-auto">
          <RevealOnScroll>
            ...
            <p className="text-white/60 text-lg leading-relaxed mb-4">
              Bioliffe Moringa Perú nace de la convicción de que el bienestar y la oportunidad de negocio pueden
            ...
            <p className="text-white/60 text-lg leading-relaxed">
              Hoy somos una comunidad activa en Perú y Paraguay, liderada por Javier Quintana Mendoza, distribuidor
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-8">
          ...
          <RevealOnScroll delay={0.1}>
            <div className="h-full bg-white/5 border border-white/10 rounded-3xl p-10">
              ...
              <p className="text-white/60 leading-relaxed">
                Ser la comunidad de bienestar y negocio de referencia en Perú y Latinoamérica, reconocida por la
      ...
      <section className="relative py-24 px-6 text-center">
        <RevealOnScroll>
          <div className="max-w-2xl mx-auto bg-green-700/20 border border-green-500/20 rounded-3xl py-14 px-8">
            ...
            <p className="text-white/60 mb-8">Sumate a la comunidad Bioliffe Moringa Perú hoy mismo.</p>
            <a

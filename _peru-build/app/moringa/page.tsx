...
export const metadata: Metadata = {
  title: "La Moringa | Bioliffe Moringa Perú",
  description:
  ...
  openGraph: {
    ...
    url: "https://www.bioliffemoringaperu.com/moringa",
  },
};
        ...
        <div className="max-w-4xl mx-auto">
          <RevealOnScroll>
            ...
            <p className="text-white/60 text-lg leading-relaxed">
              ...
              razones por las que su cultivo se ha expandido en regiones tropicales como Perú.
            </p>
          </RevealOnScroll>
        </div>
      </section>

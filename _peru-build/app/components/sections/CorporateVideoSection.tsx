...
/**
 * Sección "Descubre Bioliffe Perú": video principal + descripción +
...
export default function CorporateVideoSection() {
  ...
  const benefits = [
    ...
    "Distribución con presencia en Perú, Paraguay y Latinoamérica.",
  ];
      ...
      <div className="max-w-6xl mx-auto">
        <RevealOnScroll>
          <div className="text-center mb-16">
            ...
            <h2 className="text-5xl md:text-6xl font-black text-white mb-4">Descubre Bioliffe Perú</h2>

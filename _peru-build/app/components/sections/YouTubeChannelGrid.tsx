...
export default function YouTubeChannelGrid({ videos }: Props) {
  ...
  const openVideo = (v: YouTubeVideo) => {
    setPlaying({
      id: v.id,
      title: v.title,
      description: v.description || "Contenido oficial del canal de Bioliffe Moringa Perú.",
      category: "Canal",
      tags: [],
      youtubeId: v.id,
        ...
        <RevealOnScroll>
          <div className="text-center mb-12">
            ...
            <p className="text-white/50 text-lg max-w-2xl mx-auto">
              {videos.length} videos traídos automáticamente desde el canal de Bioliffe Moringa Perú.
            </p>
          </div>
        </RevealOnScroll>

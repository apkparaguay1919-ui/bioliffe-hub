// Catálogo de video de Bioliffe Moringa Perú.
//
...
export const YOUTUBE_CHANNEL_SEARCH_URL =
  "https://www.youtube.com/results?search_query=Bioliffe+Moringa+Peru";

export const videos: VideoEntry[] = [
  {
    id: "producto-1",
    title: "Descubre Bioliffe Perú",
    description:

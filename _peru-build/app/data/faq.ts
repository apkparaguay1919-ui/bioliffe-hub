...
export const faqs: FaqItem[] = [
  ...
  { id: 22, category: "Negocio", question: "¿El negocio funciona en toda Latinoamérica?", answer: "Actualmente tenemos presencia en Perú, Paraguay y estamos en expansión hacia otros países de la región." },
  ...
  { id: 31, category: "Compras y pagos", question: "¿Hacen envíos a todo Perú?", answer: "Sí, coordinamos envíos según cobertura disponible; consulta tiempos y costos por WhatsApp." },
  { id: 32, category: "Compras y pagos", question: "¿Puedo comprar desde otro país?", answer: "Sí, contamos con distribución en Paraguay y estamos ampliando cobertura; escríbenos para coordinar tu pedido." },
  ...
  // Distribución
  { id: 35, category: "Distribución", question: "¿En qué ciudades hay distribuidores activos?", answer: "Contamos con distribuidores en distintas ciudades de Perú; consulta el mapa de cobertura en la sección correspondiente." },
